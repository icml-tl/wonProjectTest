        ...
        <div class="flex flex-col">
          <div class="flex flex-row items-center justify-between px-4 py-4">
            ...
            <div class="flex-1 pl-1">
              ...
              <div class="text-sm text-gray-400 sm:text-base">Active Sessions</div>
            </div>
          </div>
        ...
        <div class="flex flex-col">
          <div class="flex flex-row items-center justify-between px-4 py-4">
            ...
            <div class="flex-1 pl-1">
              ...
              <div class="text-sm text-gray-400 sm:text-base">Add to Cart</div>
            </div>
          </div>
          <div class="px-4 pt-px">
            <div class="w-full h-2 bg-gray-200 rounded-md hover:bg-gray-300">
        ...
        <div class="flex flex-col">
          <div class="flex flex-row items-center justify-between px-4 py-4">
            ...
            <div class="flex-1 pl-1">
              ...
              <div class="text-sm text-gray-400 sm:text-base">Newsletter Sign Ups</div>
            </div>
          </div>
          <div class="px-4 pt-px">
            <div class="w-full h-2 bg-gray-200 rounded-md hover:bg-gray-300">
